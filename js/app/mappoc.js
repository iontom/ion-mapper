var Map = {
    ...
    setCanvasName: function(mapframe) {
        this.canvas = mapframe;
    },

    generate: function(mapframe) {
...
window.onload = function() {
  var map1 = Map;
  var map2 = Map;
  //map1.generate(document.getElementById('boxside-01'));
  //map2.generate(document.getElementById('boxside-02'));
  ...
  var mapAdj = {
    ...
    renderVoronoiView(){
        map1.setCanvasName(document.getElementById('boxside-01'));
        map1.renderVoronoiView();

        map2.setCanvasName(document.getElementById('boxside-02'));
        map2.renderVoronoiView();
    },
    renderStainedGlassView(){
        map1.setCanvasName(document.getElementById('boxside-01'));
        map1.renderStainedGlassView();

        map2.setCanvasName(document.getElementById('boxside-02'));
        map2.renderStainedGlassView();
    }
  ...
  var gui = new dat.GUI();
  gui.add(mapAdj, 'numberOfSites', 15, 8000);
  gui.add(mapAdj, 'chanceOfWater', 0, 100);
  gui.add(mapAdj, 'numberOfZones', 4, 200);
  gui.add(mapAdj, 'consistency', 0, 30);
  gui.add(mapAdj, 'generate');
  //gui.add(map, 'saveImage');
  gui.add(mapAdj, 'xsize',300,1920);
  gui.add(mapAdj, 'ysize',600,1080);
  var viewFolder = gui.addFolder('Alternate Views');
  viewFolder.add(mapAdj, 'renderVoronoiView');
  viewFolder.add(mapAdj, 'renderStainedGlassView');
  viewFolder.add(map1, 'renderZoneView');
  viewFolder.add(map1, 'renderGriddedView');
  viewFolder.add(map1, 'renderGriddedPoliticalView');
  viewFolder.add(map1, 'renderPoliticalView');
  viewFolder.open();
};
